...
export default function Footer() {
    return (
        <div>
            <footer className="bg-sky-600 text-white fixed bottom-0 left-0 right-0">
                <div className="flex pl-3 items-center h-16 bg-sky-600 text-white relative shadow-xl rounded-b-xl font-semibold" role="navigation">
